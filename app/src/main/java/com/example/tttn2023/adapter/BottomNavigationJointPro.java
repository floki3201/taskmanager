...
import com.example.tttn2023.fragment.FragmentListJointPro;
import com.example.tttn2023.fragment.FragmentListPerPro;
import com.example.tttn2023.fragment.FragmentSearch;

public class BottomNavigationJointPro extends FragmentPagerAdapter {
    public BottomNavigationJointPro(@NonNull FragmentManager fm, int behavior) {
        super(fm, behavior);
    }
    ...
    public Fragment getItem(int position) {
        switch (position){
            case 0:return new FragmentListJointPro();
